...
export function TableRow({
  ...
  return (
    <tr
      className={cn(
        "relative border-b border-(--table-border) [--table-border:color-mix(in_srgb,var(--card),var(--color-black)_8%)] dark:[--table-border:color-mix(in_srgb,var(--card),var(--color-white)_6%)] not-in-data-[variant=card]:hover:bg-[color-mix(in_srgb,var(--background),var(--color-black)_2%)] not-in-data-[variant=card]:data-[state=selected]:bg-[color-mix(in_srgb,var(--background),var(--color-black)_4%)] dark:not-in-data-[variant=card]:data-[state=selected]:bg-[color-mix(in_srgb,var(--background),var(--color-white)_4%)] dark:not-in-data-[variant=card]:hover:bg-[color-mix(in_srgb,var(--background),var(--color-white)_2%)]",
        className,
      )}
      data-slot="table-row"
      {...props}
